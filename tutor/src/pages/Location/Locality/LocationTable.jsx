...
const LocationTable = ({setIsModal,isModal,data,fetchData,Current_user}) => {


  const handleDelete = async (location_name) => {
    try {
      const response = await axios.delete(
        `${API}/deletelocation?location_name=${location_name}`
      );
  ...
  return (
    ...
    <Card>
                ...
                {page.map((row) => {
                  ...
                  return (
                    <tr {...row.getRowProps()} key={row.original._id}>
                      ...
                      <td className="table-td text-center">{row.original.location_name}</td>
                        ...
                        <div className="d-flex justify-around rtl-space-x-reverse">
                          ...
                          >
                            <button
                              ...
                              type="button"
                              onClick={() => handleDelete(row.original.location_name)}
                            >
      ...
      {isModal && (
      <LocationForm setIsModal={setIsModal} fetchData={fetchData}/>
    )}
    </>
  );
};
